            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    <div className="bg-white p-8 rounded-lg shadow-lg">
                        <h3 className="text-xl text-gray-600 mb-4">Stater</h3>
                ...
                <div className="max-w-xl mx-auto">
                    ...
                    <div className="relative px-4">
                        <div className="flex items-center gap-2">
                            ...
                            <input className="flex-1 h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer" type="range" min='1' max='50' value={productCount} onChange={(e)=>setProductCount(parseInt(e.target.value))} name="" id="" />
                            <span>50</span>
                        </div>
                    </div>
                </div>
